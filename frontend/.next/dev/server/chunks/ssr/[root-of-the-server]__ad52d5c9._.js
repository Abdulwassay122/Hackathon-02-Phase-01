...
"[project]/src/components/ErrorDisplay.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TaskItem({ task, onTaskUpdated, onTaskDeleted }) {
    ...
    const handleToggleComplete = async ()=>{
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].patch(`/tasks/${task.id}/complete`);
            onTaskUpdated();
        } catch (err) {
    ...
    const handleUpdate = async (e)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].put(`/tasks/${task.id}`, {
                title,
                description
            });
            onTaskUpdated();
    ...
    const handleDelete = async ()=>{
        if (window.confirm('Are you sure you want to delete this task?')) {
            setLoading(true);
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].delete(`/tasks/${task.id}`);
                onTaskDeleted();
            } catch (err) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ErrorDisplay$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ErrorDisplay.tsx [app-ssr] (ecmascript)");
...
function TaskList({ userId }) {
    ...
    const fetchTasks = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].get('/tasks');
            setTasks(data);
        } catch (err) {
    ...
    if (error) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ErrorDisplay$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        message: error,
        onRetry: fetchTasks
    }, void 0, false, {
        fileName: "[project]/src/components/TaskList.tsx",
...
function TaskForm({ userId, onTaskCreated }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].post('/tasks', newTask);
            setTitle('');
            setDescription('');
            onTaskCreated();
        } catch (err) {
...
;
function Dashboard() {
    const [userId, setUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(1); // In a real app, this would come from auth context
    const [tasks, setTasks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [refreshTrigger, setRefreshTrigger] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad52d5c9._.js.map