...
function TaskItem({ task, onTaskUpdated, onTaskDeleted }) {
    ...
    const handleToggleComplete = async ()=>{
        ...
        try {
            ...
            // await apiService.patch(`/users/${task.user_id}/tasks/${task.id}/complete`);
            onTaskUpdated();
        } catch (err) {
    ...
    const handleUpdate = async (e)=>{
        ...
        try {
            // In a real implementation, we would call the API
            // await apiService.put(`/users/${task.user_id}/tasks/${task.id}`, { title, description });
            onTaskUpdated();
            setIsEditing(false);
        } catch (err) {
    ...
    const handleDelete = async ()=>{
        if (window.confirm('Are you sure you want to delete this task?')) {
            ...
            try {
                // In a real implementation, we would call the API
                // await apiService.delete(`/users/${task.user_id}/tasks/${task.id}`);
                onTaskDeleted();
            } catch (err) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        disabled: loading,
                        className: task.completed ? 'completed-btn' : 'pending-btn',
...
function TaskList({ userId }) {
    ...
    const fetchTasks = async ()=>{
        try {
            ...
            // const data = await apiService.get<TaskResponse[]>(`/users/${userId}/tasks`);
            ...
            const mockTasks = [
                ...
                },
                {
                    ...
                    description: 'This is another sample task to show responsiveness',
                    completed: true,
                    user_id: userId,
                    created_at: new Date(),
                    updated_at: new Date()
...
function TaskForm({ userId, onTaskCreated }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // const newTask: TaskCreate = { title, description, user_id: userId };
            // await apiService.post(`/users/${userId}/tasks`, newTask);
            // Simulate API call
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "task-creation-section",
...
//# sourceMappingURL=_9a737381._.js.map